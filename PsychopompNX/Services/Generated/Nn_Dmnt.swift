class NnDmnt_IInterface: IpcService {
	func breakDebugProcess(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#BreakDebugProcess") }
	func terminateDebugProcess(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TerminateDebugProcess") }
	func closeHandle(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#CloseHandle") }
	func loadImage(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#LoadImage") }
	func getProcessId(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#GetProcessId") }
	func getProcessHandle(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#GetProcessHandle") }
	func waitSynchronization(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#WaitSynchronization") }
	func getDebugEvent(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#GetDebugEvent") }
	func getProcessModuleInfo(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#GetProcessModuleInfo") }
	func getProcessList(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#GetProcessList") }
	func getThreadList(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#GetThreadList") }
	func getDebugThreadContext(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#GetDebugThreadContext") }
	func continueDebugEvent(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#ContinueDebugEvent") }
	func readDebugProcessMemory(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#ReadDebugProcessMemory") }
	func writeDebugProcessMemory(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#WriteDebugProcessMemory") }
	func setDebugThreadContext(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#SetDebugThreadContext") }
	func getDebugThreadParam(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#GetDebugThreadParam") }
	func initializeThreadInfo(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#InitializeThreadInfo") }
	func setHardwareBreakPoint(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#SetHardwareBreakPoint") }
	func queryDebugProcessMemory(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#QueryDebugProcessMemory") }
	func getProcessMemoryDetails(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#GetProcessMemoryDetails") }
	func attachByProgramId(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#AttachByProgramId") }
	func attachOnLaunch(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#AttachOnLaunch") }
	func getDebugMonitorProcessId(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#GetDebugMonitorProcessId") }
	func getJitDebugProcessList(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#GetJitDebugProcessList") }
	func createCoreDump(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#CreateCoreDump") }
	func getAllDebugThreadInfo(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#GetAllDebugThreadInfo") }
	func targetIO_FileOpen(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_FileOpen") }
	func targetIO_FileClose(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_FileClose") }
	func targetIO_FileRead(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_FileRead") }
	func targetIO_FileWrite(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_FileWrite") }
	func targetIO_FileSetAttributes(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_FileSetAttributes") }
	func targetIO_FileGetInformation(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_FileGetInformation") }
	func targetIO_FileSetTime(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_FileSetTime") }
	func targetIO_FileSetSize(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_FileSetSize") }
	func targetIO_FileDelete(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_FileDelete") }
	func targetIO_FileMove(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_FileMove") }
	func targetIO_DirectoryCreate(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_DirectoryCreate") }
	func targetIO_DirectoryDelete(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_DirectoryDelete") }
	func targetIO_DirectoryRename(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_DirectoryRename") }
	func targetIO_DirectoryGetCount(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_DirectoryGetCount") }
	func targetIO_DirectoryOpen(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_DirectoryOpen") }
	func targetIO_DirectoryGetNext(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_DirectoryGetNext") }
	func targetIO_DirectoryClose(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_DirectoryClose") }
	func targetIO_GetFreeSpace(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_GetFreeSpace") }
	func targetIO_GetVolumeInformation(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#TargetIO_GetVolumeInformation") }
	func initiateCoreDump(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#InitiateCoreDump") }
	func continueCoreDump(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#ContinueCoreDump") }
	func addTTYToCoreDump(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#AddTTYToCoreDump") }
	func addImageToCoreDump(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#AddImageToCoreDump") }
	func closeCoreDump(_ _0: Any?) throws -> Any? { throw IpcError.unimplemented(name: "nn::dmnt::nn::dmnt::IInterface#CloseCoreDump") }
