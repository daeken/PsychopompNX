...
class NnsHosbinder_IHOSBinderDriver_Impl: NnsHosbinder_IHOSBinderDriver {
    ...
    override func transactParcelAuto(_ id: Int32, _ code: UInt32, _ parcel_data: Buffer<UInt8>, _ flags: UInt32, _ parcel_reply: Buffer<UInt8>) throws {
        GraphicCore.instance.nvFlinger.processParcel(code, parcel_data, parcel_reply)
    }
}
